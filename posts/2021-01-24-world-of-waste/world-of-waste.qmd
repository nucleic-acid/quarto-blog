...
categories:
  ...
  - environment
  - international
image: images/Sigle-recyclage.jpg
image-alt: "Recycling Logo with three green arrows creating a triangle."
---
...
```{r, fig.cap="Absolute amount of waste reported to the UN between 1995 - 2015"}
waste_pop_gdp %>% 
  group_by(Year) %>% 
