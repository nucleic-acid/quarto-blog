...
date: 2021-01-01
bibliography: ../../assets/JD_library.bib
categories:
  - R
  - sports
  - international
  - tidy tuesday
image: MoreAthletesMoreMedals.png
image-alt: "A plot from the post showing a positive correlation between the number of participating athletes and medals won per caountry."
aliases: 
  - ../../../posts/2021-01-01-olympic-history/index.html
---
...
```{r, fig.cap="The number of NOCs that participated in the Olympic Games over time. WW I / II: Breaks due to World Wars I and II."}
athlete_events %>%
...
```{r, fig.cap="Top scoring male athlets, sorted descending by total medal count. To resolve ties, the medal_score values gold > silver > bronze (See. code for calculation)."}
athlete_events %>% 
...
```{r, fig.cap="Bar chart race of the Top 10 NOCs for the total medal count over 120 years. NOCs: USA (United States of America), URS (Soviet Union), GER (Germany), GBR (Great Britain), FRA (France), ITA (Italy), SWE (Sweden), CAN (Canada), AUS (Australia), RUS (Russia), HUN (Hungary), FIN (Finland), NOR (Norway), BEL (Belgium), GDR (East Germany)"}
